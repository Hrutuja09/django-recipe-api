...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrieve_recipe(self):
        """Tests retrieving a list of recipe"""
    ...
    def test_create_recipe_with_new_tags(self):
        """Test creating the recipe with new tags"""
        payload = {
            'title': 'NewSample recipe title',
            'time_minutes': 10,
            'price': Decimal('5.50'),
    ...
    def test_create_recipe_with_new_ingredient(self):
        """Test creating the recipe with new ingredient"""
        payload = {
            'title': 'NewSample recipe title',
            'time_minutes': 10,
            'price': Decimal('5.50'),
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        self.assertEqual(recipes.count(),1)
        recipe = recipes[0]
        self.assertEqual(recipe.ingredients.count(),2) # To ensure it has created only 2 ingredients and not three.
...
class ImageUploadTests(TestCase):
    ...
    def tearDown(self):
        """It runs after the tests.""" # it deletes the image as the part of the recipe.
